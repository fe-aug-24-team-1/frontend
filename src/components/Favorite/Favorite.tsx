...
export const Favorite: React.FC = () => {
  const test = false; // favorite arr.length

  return (
    <div className={styles[`favorite-page`]}>
      <div className={styles.container}>
        <div className={styles[`favorite-page__brad-crams`]}></div>

        <h2 className={styles[`favorite-page__title`]}>Favorite</h2>

        <p className={styles[`favorite-page__counter`]}>
          {/*don`t forget to remove 's' if there`s only 1 item*/}
